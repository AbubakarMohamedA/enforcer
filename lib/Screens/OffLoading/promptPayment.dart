...
class promptOffLoadingPayment extends StatefulWidget {
  var token;
  ...
  @override
  State<promptOffLoadingPayment> createState() => _promptOffLoadingPaymentState();
}

class _promptOffLoadingPaymentState extends State<promptOffLoadingPayment> {
  ...
  void initializeData(){
    setState(() {
      ...
      print("The vicle id is ${widget.capturedVehicleId}");
  ...
  List<String> vehicleType = [
    "PickUp",
    "Canter/Lorry below 7 tonnes",
    "over 7 tonnes",
    "20ft container and over"
  ];
