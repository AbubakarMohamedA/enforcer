...
class PenalizedgoodDetailsAdd extends StatefulWidget {
  var goodsOrigin;
  var destination;
  var vehicleType;
  var plateNumber;
  ...
  @override
  State<PenalizedgoodDetailsAdd> createState() => _PenalizedgoodDetailsAddState();
}

class _PenalizedgoodDetailsAddState extends State<PenalizedgoodDetailsAdd> {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Flexible(
                                    child: Text(widget.penalty.toString(),
                                      style: GoogleFonts.manrope(
                                        fontSize: fontSize,
                                        fontWeight: FontWeight.w500,
                                        color: Colors.black,
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async{
                                          ...
                                          if(selectedItems == null)
                                          {
                                            ...
                                            //
                                            // bool isItemNameExisting = selectedProductsList.any((product) =>
                                            // product.itemChosen!.itemName! == selectedUomItem?.itemName);
                                            //
                                            // // bool isItemFlatRateExists = selectedProductsList.any((product) =>
                                            // // product.itemChosen!.uom!.contains('Flat'));
                                            //
                                            // bool isItemFlatRateExists = selectedProductsList.any((product) =>
                                            //     product.itemChosen!.uom!.contains('Flat'));
                                            //
                                            // if(isItemNameExisting && isItemFlatRateExists){
                                            //   Get.snackbar(
                                            //     'Oops',
                                            ...
                                            //     borderRadius: 10.0, // Adjust border radius if needed
                                            //   );
                                            // }else if(isItemNameExisting && selectedUomItem!.uom!.contains('Flat')){
                                            //   Get.snackbar(
                                            //     'Oops',
  ...
  void _submitForm() async {
    if(selectedProductsList.isEmpty){
      ...
      String cleanedPenalty = widget.penalty.replaceAll(',', '');
      cleanedPenalty = cleanedPenalty.split('.')[0];
      int number = int.parse(cleanedPenalty);
      ...
      await ApiProvider()
        ...
        if(value['status'] == "success"){
          ...
          print('DEBUG PenalizedEnterGoodDetails postOffloadingItems response: $value');
